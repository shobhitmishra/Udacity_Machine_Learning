...
class LearningAgent(Agent):
    ...
    def reset(self, trial, destination=None, testing=False):
        ...
        self.epsilon = math.exp(-self.a*trial)       

        if(testing):
            self.epsilon = 0.0
            self.alpha = 0.0

        print len(self.Q), self.epsilon, self.alpha
        return None
...
def run():
    ...
    sim = Simulator(env, display=False, log_metrics=True, update_delay=0.0, optimized=True)
