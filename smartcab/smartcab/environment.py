...
class Environment(object):
    ...
    def reset(self, trial, testing=False):
        ...
        for agent in self.agent_states.iterkeys():
            ...
            agent.reset(trial=trial, destination=(destination if agent is self.primary_agent else None), testing=testing)
            if agent is self.primary_agent:
    ...
    def step(self, trial):
        ...
        if self.primary_agent is not None:
            self.primary_agent.update(trial)
